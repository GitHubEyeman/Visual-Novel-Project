label helpaidil:
    ...
    mc "Hey Aidil. Got a minute?"
    show aidil at right with dissolve
    a "Oh Tuah, yeah. I got some minute to spare."
    mc "Remember when I told you about the letter?"
    a "Oh yeah, I do. Do you found the guy."
    mc "..."
    mc "It's you isn't it?"
    a "Huh?"
    mc "You're the one who wrote it right"
    show aidil thinking at right with dissolve
    "...."
    mc "Do you actually have a problem? A very big problem? Is that why you say people don't know how to tell people their problem?"
    mc "Because you yourself doesn't know how to express your problems?"
    show aidil at right with dissolve
    a "Haha. Is it really that obvious?"
    mc "Well, not really but I could feel like you drop some hints for me to pick up. So you admit you're the one who wrote it?"
    a "...Yeah. I wrote it"
    mc sad "But why you never told me about it? I'm your best friend. What's this problem you had anyway."
    show aidil side at right with dissolve
...
label helpsara:
    mc normal "I'm sure Sara need my help. Maybe she's really shy."
    ...
    s "Uhhhh..."
    show sara normal at right with dissolve
    ...
    s " No, I don't sit alone because I'm depressed. I just like being alone by myself. I enjoy it. It's so calm"
    s "Adding with me being shy, but that's not the point. Just because someone is always alone doesn't mean they're depressed or anything."
    mc "Wait, so I really just pick a wrong person!"
    s "I have no idea what you're talking about"
    mc "Oh no, and it's so late already, most students already went home. Uhhh see you tomorrow Sara"
    s "Oh uhh Bye-"
    "Before Sara could properly say goodbye, Tuah already rush out of the library"
    hide sara normal with dissolve
    mc "I just hope nothing happened tomorrow."
    jump day3
...
label helpziad:
    ...
    mc "Maybe he's on front gate already."
    mc "I need to be quick."
    scene schoolfrontgate with fade
    mc normal "There he is. Ziad, wait!"
    show ziad at right with dissolve
    z "Hmmm. Oh Tuah."
    mc "Huff huff, give me a minute. I should really exercise more."
    mc "You can't go home yet."
    z "Uhhh..Why?"
    ...
    mc "You know how you are so stressed from your exam that you are required to get full marks. Isn't that because of your parents' pressure?"
    ...
    z "Because I want to, duh. I pressure myself"
    mc "Wait what?! So, my deduction is wrong? You didn't write and sent me a letter?"
    z "Why would I write you a letter- I'm leaving already"
    hide ziad glasses
    "Ziad left Tuah alone while he's still speechless"
    mc "Does that mean I just make a wrong choice?! Ah! I just hope nothing happens tomorrow"
    jump day3